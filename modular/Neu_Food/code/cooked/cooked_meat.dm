...
// Fried heart
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/heart/fried
	name = "fryheart"
	desc = "Crispy on the outside, still beating on the inside."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedheart"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("frysteak" = 3, "butter" = 1)
	foodtype = MEAT | FRIED | GROSS   
	bitesize = 4
	eat_effect = null
	faretype = FARE_NEUTRAL
	rotprocess = SHELFLIFE_DECENT
...
// Fried liver
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/liver/fried
	name = "fryliver"
	desc = "Rich and iron-heavy."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedliver"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("frybird" = 2, "onion" = 1)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 3
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried stomach
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/stomach/fried
	name = "frystomach"
	desc = "Chewy tripe that still smells like the last guy's lunch."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedstomach"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("frysteak" = 3, "acid" = 1)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 4
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried lungs
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/lungs/fried
	name = "frylungs"
	desc = "Light, spongy, and tastes like a lifetime of smoking rolled into one bite."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedlungs"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("fryvolf" = 2, "tar" = 1)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 4
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried normal tongue
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/tongue/fried
	name = "frytongue"
	desc = "Chewy and still trying to taste the last word its owner said."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedtongue"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("frysteak" = 2)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 3
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried harpy tongue
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/tongue/harpy/fried
	name = "frychirp"
	desc = "Sweet chirping regrets."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedgolem"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("frybird" = 2)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 3
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried lizard tongue
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/tongue/lizard/fried
	name = "fryhiss"
	desc = "Long, forked, and lately sibilant."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedlizard"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("frysteak" = 2, "heat" = 1)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 3
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried ears
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/ears/fried
	name = "fryears"
	desc = "Now they'll never hear the end of it."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedears"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("crunchy volfmeat" = 3)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 2
	eat_effect = null
	faretype = FARE_NEUTRAL
...
// Fried eyes
/obj/item/reagent_containers/food/snacks/rogue/meat/organ/eye/fried
	name = "fryeyes"
	desc = "Crispy outside, a bit gooey inside. Still staring at you like you owe it something."
	icon = 'modular/Neu_Food/icons/cooked/cooked_meat.dmi'
	icon_state = "friedeyes"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
	tastes = list("crispy jelly" = 3)
	foodtype = MEAT | FRIED | GROSS
	bitesize = 2
	eat_effect = null
	faretype = FARE_NEUTRAL
